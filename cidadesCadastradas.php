...
if ($estaLogado == "SIM" && !isset($active)) {
    ...
    while ($dbCidade = $buscaCidade->fetch_object()) {
        ...
        $usuarioEdicao[] = $dbCidade->usuario_edicao_cidade;
        $dataEdicao[] = $dbCidade->data_edicao_cidade;

        $smarty->assign("data_edicao_cidade", $dataEdicao);
        $smarty->assign("usuario_edicao_cidade", $usuarioEdicao);
    ...
    $smarty->assign("conteudo", "paginas/cidadesCadastradas.tpl");
