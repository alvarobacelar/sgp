<div class="panel panel-success">
    ...
    <div class="panel-heading">
        ...
        <h2 class="panel-title">Liquidar empenho por cidade</h2>
    </div>
                ...
                {section name=a loop=$nomeCidade}
                    <tr class="text-center">
                        ...
                        {else}
                            ...
                            <td class="active">
                                <a href="liquidarEmpenho.php?id={$idCidade[a]}" class="btn btn-success btn-xs"> <span class="glyphicon glyphicon-ok-sign"></span> Liquidar empenho</a>
