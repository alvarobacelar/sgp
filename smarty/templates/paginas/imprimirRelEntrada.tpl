    ...
    <body>
        ...
        <div class="row-fluid" style="margin-top: -500px;">              
            <div class="span2 pull-left">
                ...
                <h3 style="">Relatorio de entrada de pipeiros no Batalhão no dia: {$dataInicio}</h3>
                Total de pipeiros: <strong>{$totalRps}</strong>
            </div>
        </div><br>
{if !empty($gfip)}
        ...
        {foreach $gfip as $g}
            <tr>
                <td>{$g->nome_pipeiro}</td>
                <td><center>{$g->identidade_pipeiro}</center></td>
                <td><center>{$g->cpf_pipeiro}</center></td>
                <td><center>{$g->nome_cidade_atuante}</center></td>
