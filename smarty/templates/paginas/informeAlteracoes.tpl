<div class="panel panel-default">
    ...
    <div class="panel-body">
        ...
        <form action="includes/controllers/informeAlteracoesControl.php" method="post" name="formInfoAlteracao" class="form-horizontal" role="form">
            ...
            <input type="hidden" id="inputIdPipeiro" name="inputIdPipeiro" value="{$nomeInfo->id_pipeiro}">

            <div class="form-group">
                <label for="inputNomePipeiro" class="col-sm-2 control-label">Nome do Pipeiro</label>
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputNomePipeiroAlt" name="inputNomePipeiroAlt" required="" title="" value="{if !empty($nomeInfo)}{$nomeInfo->nome_pipeiro}{/if}" placeholder="Nome do Pipeiro">
                </div>
            </div>
