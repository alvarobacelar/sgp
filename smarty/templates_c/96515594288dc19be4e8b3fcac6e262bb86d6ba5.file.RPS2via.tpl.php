...
<html lang="pt-br">
 ...
 /<?php echo $_smarty_tpl->tpl_vars['mesNumero']->value;?>
                    ...
                    <tr>
                        ...
                        <td colspan="5" style="font-size: 13px">AO TRANSPORTE E DISTRIBUIÇÃO DE ÁGUA POTÁVEL DA OP PIPA NO MUNICÍPIO DE &nbsp;<strong><?php if ($_smarty_tpl->tpl_vars['rps']->value->cidade_atuacao_rps!=null){?><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['rps']->value->cidade_atuacao_rps, 'UTF-8');?>
 <?php }else{ ?> <?php echo $_smarty_tpl->tpl_vars['rps']->value->nome_cidade_atuante;?>
 <?php }?></strong></td>
