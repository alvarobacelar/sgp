<?php /* Smarty version Smarty-3.1.13, created on 2015-01-27 17:26:11
         compiled from "/var/www/html/sisGerPipa/smarty/templates/paginas/imprimeContrato.tpl" */ ?>
<?php /*%%SmartyHeaderCode:103370181154bf955891ca04-01374287%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    'e3f9fb4f7f39ade8d448015344d1f54cedacec19' => 
    array (
      0 => '/var/www/html/sisGerPipa/smarty/templates/paginas/imprimeContrato.tpl',
      1 => 1422379570,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '103370181154bf955891ca04-01374287',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.13',
  'unifunc' => 'content_54bf955893c869_08675242',
  'variables' => 
  array (
    'om' => 0,
    'numeroContrato' => 0,
...
<?php if ($_valid && !is_callable('content_54bf955893c869_08675242')) {function content_54bf955893c869_08675242($_smarty_tpl) {?><?php if (!is_callable('smarty_modifier_date_format')) include '/var/www/html/sisGerPipa/smarty/lib/plugins/modifier.date_format.php';
?><html lang="pt-br">
    <head>
        <meta charset="utf-8" />
    ...
    <body>
        ...
        <p align="center" style="font-size: 12px;"> <strong>MINISTÉRIO  DA DEFESA</strong><br />
            ...
            <strong><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['om']->value->nome_om, 'UTF-8');?>
</strong><br />
        ...
        <p align="center"> <strong>CONTRATO  DE CREDENCIAMENTO NR <?php echo $_smarty_tpl->tpl_vars['numeroContrato']->value;?>
</strong><strong>/<?php echo smarty_modifier_date_format(time(),"%Y");?>
.</strong></p>
        <div style="width: 60%; margin-left: 40%;"> <!-- afastamento para a direita -->
            ...
            <p align="justify"> <strong>CREDENCIADO: </strong><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['cp']->value->nome_pipeiro, 'UTF-8');?>
</p>
            ...
            <p align="justify"> <strong>VIGÊNCIA  DO CONTRATO DE CREDENCIAMENTO</strong> <?php echo $_smarty_tpl->tpl_vars['dataInicio']->value;?>
 a <?php echo $_smarty_tpl->tpl_vars['dataFim']->value;?>
 (da data da assinatura até o último dia  de vigência deste Edital)</p>
            <p align="justify"> <br />
            </p>
        </div>
        ...
        <p align="justify"> 
            &ensp;&ensp;&ensp;&ensp;&ensp; A <strong>União</strong>,  entidade de direito público interno, por intermédio do <?php echo $_smarty_tpl->tpl_vars['om']->value->nome_om;?>
, Unidade Militar do Comando do Exército,  sediado na Cidade de <?php echo $_smarty_tpl->tpl_vars['om']->value->local_om;?>
, na Praça Marechal Floriano  Peixoto, S/N, Centro, inscrito no Cadastro Nacional de Pessoa  Jurídica (CNPJ) sob Nr <?php echo $_smarty_tpl->tpl_vars['om']->value->cnpj_om;?>
, daqui por diante denominada <strong>CREDENCIADORA</strong>,  representado neste ato pelo Sr Ten Cel <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['om']->value->comandante_om, 'UTF-8');?>
, Comandante  e Ordenador de Despesas  do <?php echo $_smarty_tpl->tpl_vars['om']->value->nome_om;?>
, residente na <?php echo $_smarty_tpl->tpl_vars['om']->value->endereco_cmt_om;?>
,  Bairro <?php echo $_smarty_tpl->tpl_vars['om']->value->bairro_cmt_om;?>
, Cidade <?php echo $_smarty_tpl->tpl_vars['om']->value->cidade_cmt_om;?>
, PNR Nr <?php echo $_smarty_tpl->tpl_vars['om']->value->numero_pnr_cmt_om;?>
, portador da Carteira  de Identidade Nr <?php echo $_smarty_tpl->tpl_vars['om']->value->identidade_cmt_om;?>
, expedida pelo Exército Brasileiro,  Cadastro de Pessoa Física (CPF) Nr <?php echo $_smarty_tpl->tpl_vars['cpf']->value->cpf_cmt_om;?>
, em conformidade com o  Art 81 das IG 12-02, aprovadas pela Portaria Ministerial Nr 305, de  24 de maio de 1995, e do outro lado, o Sr <?php echo mb_strtoupper($_smarty_tpl->tpl_vars['cp']->value->nome_pipeiro, 'UTF-8');?>
  brasileiro, Profissional Autônomo, inscrito no INSS sob Nr <?php echo $_smarty_tpl->tpl_vars['cp']->value->nit_pipeiro;?>
, residente à <?php echo $_smarty_tpl->tpl_vars['cp']->value->logradouro;?>
,  Nº, <?php echo $_smarty_tpl->tpl_vars['cp']->value->numero_endereco;?>
,
            Identidade Nr <?php echo $_smarty_tpl->tpl_vars['cp']->value->identidade_pipeiro;?>
, Cadastro de Pessoa Física (CPF) Nr  &shy;&shy;&shy;&shy;<?php echo $_smarty_tpl->tpl_vars['cp']->value->cpf_pipeiro;?>
, <span lang="pt-PT" xml:lang="pt-PT">doravante  denominado </span><span lang="pt-PT" xml:lang="pt-PT"><strong>CREDENCIADO(A)</strong></span><span lang="pt-PT" xml:lang="pt-PT">, a cujos termos as partes se vinculam, tendo em vista  o que consta no Edital de Credenciamento nº 01/2014, firmar o  presente </span><span lang="pt-PT" xml:lang="pt-PT"><strong>CONTRATO</strong></span><span lang="pt-PT" xml:lang="pt-PT">,  respeitando as cláusulas e condições seguintes:</span></p>
        <br />
        ...
        <p align="justify">
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;- Marca/Modelo/Ano de Fabricação: <?php echo $_smarty_tpl->tpl_vars['cp']->value->marca_veiculo;?>
 / <?php echo $_smarty_tpl->tpl_vars['cp']->value->modelo_veiculo;?>
 / <?php echo $_smarty_tpl->tpl_vars['cp']->value->ano_fab_veiculo;?>
 <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;- Chassis: <?php echo $_smarty_tpl->tpl_vars['cp']->value->chassis_veiculo;?>
<br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;- Placa: <?php echo $_smarty_tpl->tpl_vars['cp']->value->placa_veiculo;?>
 <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;- Cor: <?php echo $_smarty_tpl->tpl_vars['cp']->value->cor_veiculo;?>
<br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;- Capacidade da Pipa: <?php echo $_smarty_tpl->tpl_vars['cp']->value->cap_lts_veiculo;?>
. <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;&ensp;- Proprietário: <?php echo $_smarty_tpl->tpl_vars['cp']->value->proprietario_veiculo;?>
 <br />
        </p>
        <p> <br />
        </p>
        ...
        <table width="100%" cellpadding="4" border="1" cellspacing="0">
            ...
            <tr>
                ...
                <td><center><?php echo $_smarty_tpl->tpl_vars['cp']->value->nome_cidade_atuante;?>
</center></td>
                <td><center><?php echo $_smarty_tpl->tpl_vars['cp']->value->obs_cidade_atuante;?>
</center></td>
                <td><center><?php echo $_smarty_tpl->tpl_vars['cp']->value->qnt_carradas_cidade;?>
</center></td>
                <td><center><?php echo $_smarty_tpl->tpl_vars['cp']->value->numero_rotas_cidade;?>
</center></td>
                <td><center><?php echo $_smarty_tpl->tpl_vars['cp']->value->valor_estimado_cidade;?>
</center></td>
                <td><center><?php echo $_smarty_tpl->tpl_vars['cp']->value->valor_anual_cidade;?>
</center></td>
        ...
        <p align="justify">
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; - Nome: <?php echo $_smarty_tpl->tpl_vars['cp']->value->nome_pipeiro;?>
 <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; - CPF: <?php echo $_smarty_tpl->tpl_vars['cp']->value->cpf_pipeiro;?>
 <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; - Banco: <?php echo $_smarty_tpl->tpl_vars['cp']->value->banco;?>
 <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; - Agência: <?php echo $_smarty_tpl->tpl_vars['cp']->value->agencia;?>
 <br />
            &ensp;&ensp;&ensp;&ensp;&ensp;&ensp; - Conta: <?php echo $_smarty_tpl->tpl_vars['cp']->value->conta;?>
<br />
        </p>
        <p></p>
        ...
        <p align="center"> <?php echo $_smarty_tpl->tpl_vars['om']->value->local_om;?>
            ...
            <div class="row">
                <div class="col8">
                    <center>
                        ...
                        <strong><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['om']->value->comandante_om, 'UTF-8');?>
  - <?php echo $_smarty_tpl->tpl_vars['om']->value->post_grad_cmt_om;?>
            ...
            <div class="row">
                <div class="col8">
                    <center>
                        _________________________________________________<br />
                        <strong><?php echo $_smarty_tpl->tpl_vars['cp']->value->nome_pipeiro;?>
  - <?php echo $_smarty_tpl->tpl_vars['cp']->value->identidade_pipeiro;?>
</strong><br />
                        <?php echo $_smarty_tpl->tpl_vars['empresa']->value;?>
            ...
            <div class="row">
                <div class="col8">
                    <center>
                        _________________________________________________<br />
                        <strong><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['testemunha1']->value, 'UTF-8');?>
 - <?php echo $_smarty_tpl->tpl_vars['rgTestemunha1']->value;?>
</strong>
                    </center>
                </div>
                <div class="col4">
            ...
            <div class="row">
                <div class="col8">
                    <center>
                        _________________________________________________<br />
                        <strong><?php echo mb_strtoupper($_smarty_tpl->tpl_vars['testemunha2']->value, 'UTF-8');?>
 - <?php echo $_smarty_tpl->tpl_vars['rgTestemunha2']->value;?>
</strong>
                    </center>
                </div>
                <div class="col4">
